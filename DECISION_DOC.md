...
*   **Resource & Context Budget (50–100 Resources):** I specifically kept research bounded within **50–100 resources**. In testing, exceeding 100 resources bloated the context window too much for the LLM and caused latency to skyrocket, making the synthesis phase take excessively long to process. Limiting research to 50–100 sources hits the sweet spot—providing rich information depth without sacrificing processing speed.
